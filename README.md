...
Once the `conda-forge` channel has been enabled, `pyclesperanto-prototype` can be installed with:

```
conda install pyclesperanto-prototype
```

It is possible to list all of the versions of `pyclesperanto-prototype` available on your platform with:
